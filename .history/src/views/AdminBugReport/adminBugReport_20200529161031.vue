...
export default {
  ...
  async mounted() {
    ...
    const log = this.$cookies.get("log");
    const mailUser = this.$cookies.get("mailUser");
    const passwordUser = this.$cookies.get("passwordUser");
    ...
    if (
      commandStore.commit(
        ...
        this.$cookies.get("mailUser"),
        this.$cookies.get("passwordUser")
      ) != true
    ) {
