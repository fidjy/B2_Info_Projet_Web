<template>
  <div class="restaurant-container">
    ...
    <div v-for="menu in this.$cookies.keys()" :key="menu.name">{{ $cookies.remove(menu) }}</div>
    <!-- 
    {{ choiceMenus }}-->
...
export default {
  ...
  methods: {
    addChoiceMenus(menu) {
      // if (this.choiceMenus.includes(menu)) {
      //   for (const element in this.choiceMenus) {
      //     if (this.choiceMenus[element].name == menu.name) {
