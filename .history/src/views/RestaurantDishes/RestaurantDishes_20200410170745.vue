    ...
    <div class="restaurant-description">
      <v-card class="mx-auto card-margin" width="100%">
        ...
        <v-card class="restaurant-presentation">
          <v-card-title class="restaurant-title">{{ JSON.parse($route.params.restaurant).name }} {{ JSON.parse($route.params.restaurant).stars }} ⭐</v-card-title>
          <v-card-title class="restaurant-title"></v-card-title>
        </v-card>
      </v-card>
    </div>
