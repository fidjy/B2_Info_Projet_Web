<template>
  <div class="restaurant-container">
    ...
    <div v-for="menu in JSON.parse(this.$cookies.get('choiceMenus'))" :key="menu.name"></div>

    JSON.parse(this.$cookies.get('choiceMenus'))
    <v-card
      v-for="menu in menus"
      :key="menu.name"
...
export default {
  ...
  methods: {
    addChoiceMenus(menu) {
      ...
      this.$cookies.set("choiceMenus", JSON.stringify(this.choiceMenus));
    }
  },
  mounted() {
