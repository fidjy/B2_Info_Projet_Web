<template>
  <div>
    <v-card class="mx-auto card-margin" max-width="800">
      <v-img
    ...
    <v-card v-for="menu in menus" :key="menu.name" class="mx-auto card-margin" max-width="400" raised>
      <v-img class="white--text align-end" height="100vh" :src="menu.picture"></v-img>
      ...
      <v-card-actions>
        <v-btn color="primary" outlined>add</v-btn>

        <v-btn color="primary" outlined>delete</v-btn>
      </v-card-actions>
    </v-card>
  </div>
</template>
