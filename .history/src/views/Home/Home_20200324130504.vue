            ...
            <v-card>
              <v-row align="center" justify="center">
                <v-item-group class="container-picture-resto">
                  <v-item class="center-picture-resto router-link-sing-in" v-slot:default="{ active, toggle }">

                    
                      <div class="right-container-for-link-restaurant">
                        <div class="right-part-link-restaurant"></div>
                      </div>
                      <div class="left-container-for-link-restaurant">
                        <div class="left-part-link-restaurant"></div>
                      </div>
