                ...
                <v-item-group class="container-picture-resto">
                  <v-item class="center-picture-resto" v-slot:default="{ active, toggle }">
                    <div class="router-link-sing-in">
                      ...
                      <div v-if="checkFavorite(item) == true">favorit</div>
                      <div v-else>not favorit</div>
                    </div>
                  </v-item>
                </v-item-group>
              </v-row>
...
export default {
  ...
  methods: {
    ...
    checkFavorite(restaurantUserFavorit) {
      ...
      console.log(restaurantUserFavorit.usersFavorite);
      for (const value in restaurantUserFavorit.usersFavorite) {
        for (const test in restaurantUserFavorit.usersFavorite) {
          console.log(test);
        }
        console.log(value);
      }
