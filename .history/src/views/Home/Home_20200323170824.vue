    ...
    >
      ...
      <template v-slot:default="props">
        <div class="info-welcoming-container">
          ...
          >Welcome to BuberEat ! Here you can order whatever you like to eat . . . 😊</div>
        </div>
              ...
              <v-row align="center" justify="center">
                <v-item-group class="container-picture-resto">
                  <v-item class="center-picture-resto" v-slot:default="{ active, toggle }">
                    <router-link class="router-link-sing-in" :to="{ name: 'RestaurantDishes', params: { restaurant: encodeURI(JSON.stringify(item)) } }">
                      <v-img
                        :src="item.picture"
                        :alt="item.name"
