  ...
  <v-container fluid>
    ...
    >
      ...
      <template v-slot:default="props">
        <div class="info-welcoming-container center">
          <v-alert class="info-welcoming" type="info">Bienvenue sur BuberEat ! Commandez le plat qui vous fera le plus plaisir... </v-alert>
        </div>
