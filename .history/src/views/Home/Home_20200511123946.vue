    ...
    >
      ...
      <template>
        ...
        <v-row class="container-dishes">
          <v-col class="dish" v-for="item in items" :key="item.nom" cols="12" sm="6" md="4" lg="3">
            <v-card>
              ...
              <div class="description-restaurant">
                <v-card-title class="restaurant-name subheading font-weight-bold">{{ item.nom }}</v-card-title>
                <v-card-title
...
export default {
  ...
  data() {
    return {
      ...
      itemsPerPage: 4,
      sortBy: "name",
      keys: ["favorite", "tendance", "stars"],
      restaurants: [],
      items: [
        {
          nom: "Frozen Yogurt",
          stars: 5,
          picture: 'https://cac.img.pmdstatic.net/fit/http.3A.2F.2Fprd2-bone-image.2Es3-website-eu-west-1.2Eamazonaws.2Ecom.2Fcac.2F2018.2F09.2F25.2F03ab5e89-bad7-4a44-b952-b30c68934215.2Ejpeg/410x230/quality/80/crop-from/center/burger-maison.jpeg',
          carbs: 24,
          protein: 4.0,
          sodium: 87,
          calcium: "14%",
