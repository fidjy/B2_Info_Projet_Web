            ...
            <v-card>
              <v-row align="center" justify="center">
                <v-item-group class="container-picture-resto">
                  <v-item class="center-picture-resto" v-slot:default="{ active, toggle, loadingFavorit }">
                      ...
                      >
                        ...
                        <div class="favoritTendanceContainer">
                          <v-btn
                            ...
                            @click="toggle() + suppFavorit(item.id, loadingFavorit)"
                            class="button-heart"
                            icon
                            dark
                            :loading="loadingFavorit = !loadingFavorit"
                          >
                          ...
                          <v-btn
                            v-if="$cookies.get('log') && !checkFavorite(item.usersFavorits)"
                            @click="toggle() + addFavorit(item.id, loadingFavorit)"
                            class="button-heart"
                            icon
                            dark
...
export default {
  ...
  methods: {
    ...
    async suppFavorit(restaurantId, loading) {
      loading = true;
      if (this.idUser != 0) {
        await axios
    ...
    async addFavorit(restaurantId, loading) {
      loading = true;
      if (this.idUser != 0) {
