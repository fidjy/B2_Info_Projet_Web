                  ...
                  <v-item class="center-picture-resto" v-slot:default="{ active, toggle, liked }">
                    <div class="router-link-sing-in">
                      ...
                      >
                        ...
                        <div v-if="checkFavorite(item.usersFavorits, item.id, active) || liked">
                          <v-btn
                        ...
                        <div v-else>
                          <v-btn
                            v-if="$cookies.get('log')"
                            @click="changeLiked(liked) + toggle() + addFavorit(item.id)"
                            class="button-heart"
                            icon
                            dark
                          >
...
export default {
  ...
  methods: {
    ...
    checkFavorite(restaurantUserFavorit, restaurantId, active) {
      if(active){
