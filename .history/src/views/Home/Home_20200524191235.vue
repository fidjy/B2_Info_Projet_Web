                      ...
                      >
                        ...
                        <div>
                          <v-btn
                            ...
                            @click="toggle() + changeStateFavorit(active, item.id)"
                            class="button-heart"
                            icon
                            dark
                          >
                            <v-icon
                              v-if="checkFavorite(item.usersFavorits)"
                            >{{ active ? 'mdi-heart-outline' : 'mdi-heart' }}</v-icon>
                            <v-icon v-else>{{ active ? 'mdi-heart' : 'mdi-heart-outline'}}</v-icon>
                          </v-btn>
                        </div>
                      </v-img>
                    </div>
...
export default {
  ...
  methods: {
    ...
    checkFavorite(restaurantUserFavorit) {
      console.log("log : " + this.$cookies.get("log"));
      console.log("loading : " + this.loadingDataHome);
      if (this.$cookies.get("log") || this.loadingDataHome) {
        console.log("checked");
        console.log(restaurantUserFavorit);
    ...
    async addFavorit(restaurantId) {
      ...
      await axios
        ...
        .then(response => {
          ...
          console.log(this.restaurantToAdd);
        })
        .catch(function(error) {
          console.log(error);
        });
