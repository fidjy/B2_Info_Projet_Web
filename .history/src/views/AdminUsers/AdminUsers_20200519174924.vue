                  ...
                  <v-container>
                    <v-form ref="form" v-model="valid">
                      <v-row>
                        ...
                        <v-radio-group v-model="editItem.roles">
                          <v-radio v-for="role in roles" :key="role" :label="`role ${n}`" :value="n"></v-radio>
                        </v-radio-group>
                        <v-col cols="12" sm="6" md="4">
                          <v-text-field
...
export default {
  ...
  data() {
    return {
      roles: [
        "ROLE_USER", "ROLE_RESTORER", "ROLE_ADMIN", "ROLE_DELIVERER"
      ],
