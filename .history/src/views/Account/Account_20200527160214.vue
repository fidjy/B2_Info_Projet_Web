  ...
  <div class="account_container_global">
    <div class="account_container">
      <div class="login_container_input">
        <v-btn color="primary" dark large @click="surnameChange = !surnameChange" class="change_button">change surname</v-btn>
        ...
        <v-btn color="primary" dark large @click="nameChange = !nameChange" class="change_button">change name</v-btn>
