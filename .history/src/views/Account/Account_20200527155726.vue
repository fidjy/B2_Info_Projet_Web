  ...
  <div class="login_container_global">
    <div class="account_container">
      <div class="login_container_input">
        ...
        <v-form v-if="surnameChange" ref="form" v-model="valid_surname" class="form">
        ...
        <v-btn color="primary" dark large @click="nameChange = !nameChange">change surname</v-btn>

        <v-form v-if="nameChange" ref="form" v-model="valid_name" class="form">
          <div class="text_field">
            <v-text-field
              type="name"
              :rules="[rules.required]"
