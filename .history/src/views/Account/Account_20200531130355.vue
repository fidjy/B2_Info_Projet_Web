    ...
    <div class="account_container">
      <div class="login_container_input">
        ...
        <v-btn
          ...
          dark
          large
          @click="avatarChange = !avatarChange"
          class="change_button"
        >change avatar</v-btn>
        <div v-if="avatarChange" class="avatar-container">
        ...
        <div class="register_validation">
          <router-link
            v-if="(validName && nameChange) || (validSurname && surnameChange) || (validPassword && passwordChange) || (validEmail && emailChange)  || avatarChange"
            :to="{ name: '' }"
          >
            <v-btn
...
export default {
  ...
  methods: {
    ...
    getUserInformations() {
      axios
        .get("/api/users/" + this.idUser  || this.idUser != 0)
        .then(response => {
