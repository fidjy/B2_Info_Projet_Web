  ...
  <div class="login_container_global">
    <div class="login_container_border_lines">
      <div class="login_container_border_rectangle">
        <v-form ref="form" :v-model="valid" class="login_container_input" action>
          ...
          <div class="register_validation">
            <router-link :to="{ name: '' }">
              <v-btn class="login_button submit"   :disabled="!valid" large @click="Register()" outlined>Register</v-btn>
            </router-link>
          </div>
        </v-form>
        {{valid}}
