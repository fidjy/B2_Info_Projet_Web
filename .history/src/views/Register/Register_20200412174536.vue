    ...
    <div class="login_container_border_lines">
      <div class="login_container_border_rectangle">
        <form class="login_container_input" action>
          ...
          <input class="input text_field" type="password" v-model="password" />
          <password
          ...
          <div>
            ...
            <password v-model="password" :strength-meter-only="true" toggle   @score="showScore"/>
          </div>
          ...
          <div class="submitContainer">
            ...
            <router-link v-else :to="{ name: '' }">
              <v-btn class="login_button darkSubmit" large @click="CantRegister()" outlined>Register</v-btn>
            </router-link>
          </div>
        </form>
      </div>
