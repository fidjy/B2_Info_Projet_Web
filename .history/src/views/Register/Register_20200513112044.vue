...
export default {
  ...
  data() {
    return {
      ...
      errorMessage: "",
      loading: false,
      description: "wooaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",
      picture: "https://media-cdn.tripadvisor.com/media/photo-s/12/47/f3/8c/oko-restaurant.jpg",
      Roles: [
        { text: "User" },
        { text: "Restorer" },
        { text: "Admin" },
