        ...
        <form class="login_container_input" action>
          ...
          <div class="register_validation">
            ...
            <router-link v-else :to="{ name: '' }">
              <v-btn  :disabled="!valid" class="login_button darkSubmit" large @click="CantRegister()" outlined>Register</v-btn>
            </router-link>
          </div>
        </form>
      </div>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        emailMatch: () => this.password => this.password == value || "The email and password you entered don't match",
        email: value => {
