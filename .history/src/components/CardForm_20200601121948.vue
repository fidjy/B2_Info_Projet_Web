<template>
  <div class="card-form">
    ...
    <div class="card-form__inner">
      ...
      <v-btn large color="primary" class="card-form__button" v-on:click="invaildCard" :loading="loading">Submit</v-btn>
    </div>
  </div>
</template>
    ...
    async invaildCard() {
      ...
      await axios
        .post("/email", {
          ...
          commandDishes: this.commandUser,
