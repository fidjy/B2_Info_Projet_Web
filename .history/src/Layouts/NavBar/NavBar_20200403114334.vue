<template>
  <v-content>
    <v-navigation-drawer class="overflow-hidden height-nav-bar">
      <v-app-bar
        absolute
        color="#3195d7"
        dark
      ...
      <v-navigation-drawer v-model="drawerCart" absolute temporary right="true">
        <p class="font-italic">Votre commmande</p>
