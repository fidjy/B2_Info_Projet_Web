...
export default {
  ...
  watch: {
    search: function(value) {
      ...
      axios
        ...
        .then(response => (
          this.propositionAdresse = JSON.stringify(response)
        ));
    }
  },
  methods: {
  ...
  computed: {
    propositionAdresse: function (){
      this.propositionAdresse.features.forEach(street =>
       this.streets.append(street)
      );
      return ""
    }
  }
