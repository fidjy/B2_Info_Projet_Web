    ...
    <v-card class="overflow-hidden height-nav-bar">
      ...
      >
        ...
        <v-col class cols="12" sm="6" md="3">
          <v-text-field class="black" v-model="deliveryAddressInput" label="addresse de livraison" outlined></v-text-field>
        </v-col>

        <v-col class cols="12" sm="6" md="3">
          <v-text-field class="black" v-model="wantEatInput" label="Quel voulez-vous manger ?" outlined></v-text-field>
        </v-col>
