  ...
  <v-content>
    <v-sheet class="overflow-hidden height-nav-bar">
      ...
      >
        ...
        <v-toolbar-title class="title">BuberEat {{ $cookies.get('updateCommand') }}</v-toolbar-title>
          ...
          <v-card flat v-if="this.$cookies.get('log')">
            <v-card-text>
              <v-row align="center" justify="center">
                ...
                </v-btn-toggle>{{ if($cookies.get('dfsdf')) }}
              </v-row>
            </v-card-text>
          </v-card>
        </v-list>
...
export default {
  ...
  watch: {
    ...
    getCommand: async function() {
      if (this.$cookies.get("updateCommand")) {
        console.log("bit");
        this.$cookies.set("updateCommand", false);
        this.updateCommand();
        return "";
      }
      console.log(this.$cookies.get("updateCommand"));
      return "";
    }
  },
  methods: {
